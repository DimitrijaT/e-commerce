...
const ProductEdit = (props) => {
    ...
    const onFormSubmit = (e) => {
        ...
        //Оваа компонента треба да ги прати до App компонентата и таму ќе се направи axios Post request
        props.onEditProduct(props.product.id, name, price, quantity, category, manufacturer)
        // history.push("/products"); //Да не врати на страната каде што се сите продукти
        navigate('/products')
    }
                        ...
                        <select name="category" className="form-control" onChange={handleChange}>
                            {props.categories.map((term) => {
                                    if (props.product.category !== undefined &&
                                        ...
                                        return <option selected={props.product.category.id}
