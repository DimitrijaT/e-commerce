...
public class DiscountRestController {
    ...
    @PostMapping("/add") // може и немора ("/add"), конвенција е.
    ...
    //    @RequestMapping(method = RequestMethod.GET) - Постар начин
    @GetMapping
    ...
    /*
            http:localhost:9091/api/discounts/3 - PathVariable
            http:localhost:9091/api/discounts?id=3 - QueryParameter
     */
    ...
    // RequestParam може да се смени со @RequestBody, но да покажиме и ваков пример (Ова очекуваме се праќа низ некаква форма)
